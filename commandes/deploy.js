...
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 JAPHETTECH-MD
✔ Now check on Japhettech-md repository in github fork and give a star to this repository before doing anything 🌟or else Rahmani-md owner won't allow you to deploy his bot🤖.
...
✔Now click on this devs number and give Japhettech-Md owner credits https://wa.me/255788484546
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 dev Japhet`;
   var lien = mybotpic();
